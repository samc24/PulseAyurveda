...
public class FitbitAuthApplication extends Application {
    ...
    private static final String CLIENT_SECRET = "f8e5dc895b0e2865c36393167ccdd57d";
    ...
    public void onCreate() {
        super.onCreate();
        ClientCredentials clientCredentials = new ClientCredentials("22CJXV",CLIENT_SECRET, "https://finished");
